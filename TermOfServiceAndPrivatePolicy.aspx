<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TermOfServiceAndPrivatePolicy.aspx.cs" Inherits="TermOfServiceAndPrivatePolicy" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container MSZH">
            <br />
            <div class="row">
                <h2><i class="col-xl-12 mx-auto fa fa-file-text fa-fw"></i>&nbsp;隱私及服務條款&nbsp;</h2>
                <a class="btn btn-primary MSZH" id="btnReturnIndex" href="index.aspx">返回主頁面</a>
            </div>
            <hr />

            <blockquote class="col-xl-12 mx-auto">

                <p>非常歡迎您光臨<b>「來查添加物(Look up FAs)」</b>（以下簡稱本網站），為了讓您能夠安心使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：</p>
